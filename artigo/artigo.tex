...
CPU máxima observada (\% do request) & 172\%  & 385\% \\
Réplicas máximas decididas           & 5      & 5 \\
Decisão de expandir                  & 48\,s  & 35\,s \\
Decisão de ir ao máximo              & 64\,s  & 52\,s \\
Pods prontos no máximo               & 64\,s  & 52\,s \\
Custo do substrato                   & $<$5\,s & $<$5\,s \\
Decisão de reduzir                   & 395\,s & 361\,s \\
Nodes                                & 1      & 2   \\
\bottomrule
\end{tabular}
\end{table}
