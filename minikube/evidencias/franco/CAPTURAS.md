...
| `teste-carga-minikube-20260824_124853/S1-pods-antes.png` | t ≈ 25 s | HPA em `cpu: 2%/10%`, 2 réplicas, 1 m de CPU por Pod |
| `teste-carga-minikube-20260824_124853/S2-pods-durante.png` | t ≈ 230 s | HPA em `cpu: 124%/10%`, **5/5 réplicas**, os 2 geradores a ~500 m cada |
| `teste-carga-minikube-20260824_124853/S3-pods-depois.png` | t ≈ 780 s | HPA de volta a `cpu: 2%/10%`, **1 réplica** |
